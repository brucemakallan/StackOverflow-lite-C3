class TestData(object):
    ...
    # test data for users
    user_data = dict(username="jane", full_name="Jane Doe", email="jane@gmail.com", password="password123",
                     retype_password="password123")
    user_data2 = dict(username="annie", full_name="Annie Jones", email="annie@gmail.com", password="believe_you",
                      retype_password="believe_you")
    user_data3 = dict(username="jane", full_name="Jane Doe", email="jane@gmail.com", password="pass")
